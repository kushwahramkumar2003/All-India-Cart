...
const contactDetailsData = [
    {
        ...
        title:"Write To US",
        info:["Fill out our form and we will contact you within 24 hours.","Emails: customer@exclusive.com","Emails: support@exclusive.com"]
    },
]
                        ...
                        return (
                            <div className={"flex flex-col gap-2 "} key={item.title}>
                                <div className={"flex flex-row gap-3 items-center  "}>
                                    <span
                                        className={"flex justify-center items-center text-center rounded-full p-1 text-white bg-[#DB4444]"}>{item.icon}</span>
