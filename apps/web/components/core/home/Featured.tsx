...
const Featured = () => {
  return (
    <div>
      ...
      <div
        className={
          "flex flex-row gap-4 mt-4 justify-center max-sm:items-center max-sm:flex-wrap max-xmd:flex-wrap max-[800px]:flex-wrap"
        }
      >
        <div className="bg-black relative flex justify-center items-center max-sm:w-full max-[800px]:w-full">
          <Image
            src={constants.images.playstation}
            alt="playstation"
          ...
          <div className="absolute text-white -mt-0 bottom-0 left-0 right-0 z-10 gap-4 flex flex-col max-w-72 pl-10 mb-6">
            ...
            <CustomLink href="/" className={"text-lg font-semibold underline"}>
              Shop Now
            </CustomLink>
          </div>
        </div>
        <div className="flex flex-col gap-5 ">
          <div className="bg-black flex flex-row relative flex-grow w-auto">
            ...
            <div
              className={
                "flex flex-col gap-4 px-4 text-white absolute bottom-0 left-0 right-0 max-w-72 mb-6 z-10"
              }
            >
          ...
          <div className="flex flex-row justify-between gap-4">
            <div
              className="bg-black relative p-4 flex justify-center items-center
            "
            >
              <Image src={constants.images.soundbox} alt="headphone" />
              <div
                className={
                  "flex flex-col gap-1 px-4 text-white absolute bottom-0 left-0 right-0 max-w-72 mb-6 z-10"
                }
              >
