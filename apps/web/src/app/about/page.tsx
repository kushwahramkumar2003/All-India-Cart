      ...
      >
        {aboutSectionBenifits.map((item) => {
          return (
            <div
              className={
                "flex flex-col justify-center items-center text-center hover:bg-destructive hover:text-white transition-all duration-400 hover:cursor-pointer p-4 rounded-lg border border-slate-400  shadow-md"
              }
            >
              <div
                className={
                  "p-2 flex justify-center items-center  rounded-full hover:text-black "
                }
              >
                <span
                  className={
